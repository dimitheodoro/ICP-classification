...
##########################
patients = np.load("/home/theodoropoulos/PhD/Data/patients(20_120_128_128).npy",allow_pickle=True)
...
plt.title('ROC curve')
plt.savefig('/home/theodoropoulos/PhD/Results/ROC(20 patients val).png')
