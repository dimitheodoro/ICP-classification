...
# patients = list(np.load("/home/theodoropoulos/PhD/Data/patients(16_120_512_512).npy",allow_pickle=True))
...
plt.savefig('/home/theodoropoulos/PhD/Results/ROC_patches_Minority.png')
distributed_model.save('/home/theodoropoulos/PhD/Results/patches_model_minority.keras')
...
print("Patches level accuracy:")
for key,value in history.history.items():
    print("Total",key,":",value[-1])
